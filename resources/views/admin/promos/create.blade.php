        ...
        <main class="flex-grow p-6 lg:p-8 space-y-6">
            <div>
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-black text-slate-800">Tambah Promo</h1>
                        <p class="text-xs text-slate-500 mt-1">Buat banner promo baru.</p>
                    </div>
                ...
                <form action="{{ route('admin.promos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition">
                            <option value="flyer">Flyer Banner (Icon & Tombol)</option>
                            <option value="ads">Ads Banner (Gambar Background)</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="badge_1" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="Contoh: Promo Spesial">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-700 mb-1">Badge 2</label>
                            <input type="text" name="badge_2" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="Contoh: Voucher Aktif">
                        </div>
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-700 mb-1">Judul Promo *</label>
                        <input type="text" name="title" required class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="Contoh: Diskon Ongkir 50%">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-700 mb-1">Deskripsi</label>
                        <textarea name="description" rows="2" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="Gunakan promo ini untuk..."></textarea>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-slate-700 mb-1">Syarat & Ketentuan</label>
                            <input type="text" name="terms" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="*Syarat berlaku">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-700 mb-1">Teks Tombol</label>
                            <input type="text" name="button_text" class="w-full text-sm border-slate-200 rounded-xl px-4 py-2.5 focus:border-rose-500 focus:ring focus:ring-rose-200 transition" placeholder="Klaim">
                        </div>
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-700 mb-1">Gambar Banner (Khusus Tipe Ads)</label>
                    ...
                    <div class="flex items-center gap-2 mt-2">
                        <input type="checkbox" name="is_active" id="is_active" value="1" checked class="text-rose-600 border-slate-300 rounded focus:ring-rose-500">
